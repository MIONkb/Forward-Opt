...
#include "FORWARD/Support/Dnnl/DnnlUtils.h"
...
void Conv::setup(float *input, float *weight, float *bias, float *output,
  ...
  for(int i = 0; i < src_shape.size(); i++){
    llvm::errs() << (int)src_shape[i] << " ";
  }
  llvm::errs() << "\n";
  llvm::errs() << "dst_shape: ";
  for(int i = 0; i < dst_shape.size(); i++){
    llvm::errs() << (int)dst_shape[i] << " ";
  }
  llvm::errs() << "\n";
  llvm::errs() << "filter_shape: ";
  for(int i = 0; i < filter_shape.size(); i++){
    llvm::errs() << (int)filter_shape[i] << " ";
  }
  llvm::errs() << "\n";
  ...
  // llvm::errs() << "get_data_handle: ";
  // for(int i = 0; i < 768; i++){
  //   llvm::errs() << (int)p_input[i] << " ";
  // }
  // llvm::errs() << "\n";
  llvm::errs() << "sreides: ";
  for(int i = 0; i < strides.size(); i++){
    llvm::errs() << (int)strides[i] << " ";
  }
  llvm::errs() << "\n";
  llvm::errs() << "dilation: ";
  for(int i = 0; i < dilation.size(); i++){
    llvm::errs() << (int)dilation[i] << " ";
  }
  llvm::errs() << "\n";
  llvm::errs() << "padding_l: ";
  for(int i = 0; i < padding_l.size(); i++){
    llvm::errs() << (int)padding_l[i] << " ";
  }
  llvm::errs() << "\n";
  llvm::errs() << "padding_l: ";
  for(int i = 0; i < padding_r.size(); i++){
    llvm::errs() << (int)padding_r[i] << " ";
  }
  llvm::errs() << "\n";
